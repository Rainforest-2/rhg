...
|---|---|---|---|
| Summon | JS has no proc-object source loader or actor creation contract; normal CSV holder negative evidence exists | common/Android/JS summon searches listed above | JS BCU custom entity/proc-object import path; BCU `CustomEntity` serialization |
