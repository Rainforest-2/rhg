...
| poison / toxic `A_POISON` | `all-skill-effects/000001/org/battle/s8/skill008.png`, `all-skill-effects/000001/org/battle/s8/skill008.imgcut`, `all-skill-effects/000001/org/battle/s8/skill_percentage_attack.mamodel`, `all-skill-effects/000001/org/battle/s8/skill_percentage_attack.maanim`; adjacent source copies `all-skill-effects/000001/org/battle/s3/poison.png`, `all-skill-effects/100804/org/battle/s3/poison.png` | runtime loader alias `toxic` uses the `s8` source-style entries directly; no new ZIP entries were generated |
