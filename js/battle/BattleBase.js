export class BattleBase {
  constructor({ id, side, label, x, y, maxHp = 1000, collisionRadius = 80, attackable = true, visualAssetId = null, visualKind = 'simple-placeholder', layers = [], scale = 1.0, debug = {} }) {
    ...
    this.visualAssetId = visualAssetId; this.visualKind = visualKind; this.layers = layers; this.scale = scale; this.debug = debug;
  }
