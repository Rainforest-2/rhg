export const BATTLE_CONFIG = {
  ...
  tuning: { fps: 30, speedToPxPerSecond: 5.184, rangeToPx: 0.54, battleTimeScale: 0.65, minAttackWaitMs: 450, minAttackAnimMs: 500, minAttackStartupMs: 180, attackPhaseTimeMultiplier: 0.8, attackAnimationSpeedMultiplier: 1.25, attackWaitMultiplier: 1.2, knockbackPositionDistance: 50, defaultCollisionRadius: 42, dogCollisionRadius: 46, catCollisionRadius: 42, minVisualGapPx: 18, maxAliveActors: 30, maxAliveActorsPerSide: 15, spawnSeparationPx: 32, deadRemoveAfterMs: 1000, maxEffects: 40 },
  ...
  bases: { dogBase: { id: 'dog-base', side: 'dog-player', label: 'ワンコ軍 拠点', x: 1120, y: 560, maxHp: 1000, collisionRadius: 80, visualKind: 'castle-composite', visualAssetId: 'castle-composite-000', scale: 0.86, visualBottomToCurrentCenter: true }, catBase: { id: 'cat-base', side: 'cat-enemy', label: 'ネコ軍 拠点', x: 120, y: 560, maxHp: 1000, collisionRadius: 80, visualKind: 'simple-placeholder', visualAssetId: null, scale: 1.0 } },
  rosters: {
