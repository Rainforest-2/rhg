export const BATTLE_CONFIG = {
  ...
  bases: { dogBase: { id: 'dog-base', side: 'dog-player', label: 'ワンコ軍 拠点', x: 1120, y: 560, maxHp: 1000, collisionRadius: 80, visualKind: 'castle-composite', visualAssetId: 'castle-composite-000', scale: 0.86, visualBottomToCurrentCenter: true, visualYOffsetPx: -36 }, catBase: { id: 'cat-base', side: 'cat-enemy', label: 'ネコ軍 拠点', x: 120, y: 560, maxHp: 1000, collisionRadius: 80, visualKind: 'simple-placeholder', visualAssetId: null, scale: 1.0 } },
  rosters: {
