export const BATTLE_CONFIG = {
  ...
  battleCoordinate: {
    ...
    source: 'bcu-battlebox-derived-horizontal',
    projectionMode: 'bcu-battlebox-fit-stage',
    ratioPPerBcu: 768 / 2400,
    offP: 200,
    stageLenBcu: 3000,
    stageLenSource: 'bcu-default-stage-len-3000',
    stageLenFile: null,
    leftBaseSide: 'cat-enemy',
    rightBaseSide: 'dog-player',
    leftBasePosBcu: 800,
    rightBasePosMode: 'stageLenMinus800',
    basePosSource: 'bcu-stagebasis-base-offset-800',
    viewportMode: 'fit-full-stage',
    cameraXP: 0,
    cameraXSource: 'fit-full-stage-no-scroll',
    ...
    horizontalProjectionSource: 'BCU BattleBox getX formula',
    verticalProjectionSource: 'provisional-browser-groundY',
    actorVisualScaleSource: 'provisional-existing-actorGlobalScale',
    baseVisualScaleSource: 'provisional-existing-base-scale',
    backgroundVerticalSource: 'provisional-browser-groundY',
    debug: true
  },
  stage: { id: 0, imagePath: './public/assets/bcu/000001/org/img/bg/bg000.png', imgcutPath: './public/assets/bcu/000001/org/battle/bg/bg00.imgcut', csvPath: './public/assets/bcu/000001/org/battle/bg/bg.csv', cropName: '背景bg', groundY: 560, backgroundMode: 'bcu-stage0', backgroundLayout: { mode: 'bcu-background-draw', horizontalSource: 'BCU Background.draw', verticalSource: 'provisional-browser-groundY', useBcuTileOffset: true, cropScale: 1.0, cropOffsetX: 0, cropOffsetY: 130, tileX: true, cropTopFadeHeight: 160, cropTopFadeStep: 4 } },
