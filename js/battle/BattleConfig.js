export const BATTLE_CONFIG = {
  ...
  tuning: { fps: 30, speedToPxPerSecond: 5.184, rangeToPx: 0.27, battleTimeScale: 0.65, minAttackWaitMs: 450, minAttackAnimMs: 500, minAttackStartupMs: 180, attackPhaseTimeMultiplier: 0.8, attackAnimationSpeedMultiplier: 1.25, attackWaitMultiplier: 1.2, postAttackIdleHoldMs: 650, knockbackPositionDistance: 50, damageResolveMode: 'post-tick', hpKnockbackDistancePx: 60, hpKnockbackDurationMs: 260, deathHoldMs: 650, finalKnockbackBeforeDeath: true, lifecycleDebug: true, preserveFinalKnockbackActor: true, defaultCollisionRadius: 42, dogCollisionRadius: 46, catCollisionRadius: 42, minVisualGapPx: 18, maxAliveActors: 30, maxAliveActorsPerSide: 15, spawnSeparationPx: 32, deadRemoveAfterMs: 1000, maxEffects: 40, combatBodyRadiusMultiplier: 0.7, combatBodyHeightMultiplier: 2.2, combatBodyYOffsetPx: 0, combatBodyWidthPx: 44, combatBodyHeightPx: 72, hitEffectBodyYRatio: 0.55, hitEffectYOffsetPx: 0, combatPositionMode: 'bcu-pos', combatPointHalfWidthPx: 6, combatPointHeightPx: 72, combatPositionDebug: true, combatPositionAutoAlign: { enabled: false, mode: 'body-core-center', minPartWidthPx: 3, minPartHeightPx: 3, minPartAreaPx: 12, ignoreTinyAreaRatio: 0.015, ignoreFlatShadowHeightRatio: 0.18, bodyCoreTopRatio: 0.15, bodyCoreBottomRatio: 0.98, bodyCoreMinCoverageRatio: 0.16, maxAutoOffsetPx: 90 }, combatEdgeResolver: { enabled: false, mode: 'visual-leading-edge', minPartWidthPx: 3, minPartHeightPx: 3, minPartAreaPx: 12, ignoreTinyAreaRatio: 0.01, ignoreFlatShadowHeightRatio: 0.18, shadowBottomBandRatio: 0.08, maxResolvedWorldOffsetPx: 160 } },

  battleCoordinate: {
    enabled: true,
    source: 'provisional',
    coordinateMode: 'bcu-pos',
    leftBaseSide: 'cat-enemy',
    rightBaseSide: 'dog-player',
    leftBasePosBcu: 800,
    rightBasePosBcu: 5200,
    basePosSource: 'provisional-bcu-layout',
    spawnOffsetFromBaseBcu: 120,
    spawnOffsetSource: 'provisional',
    sameSideSeparationBcu: 140,
    sameSideSeparationSource: 'provisional',
    speedMode: 'derive-from-legacy-px',
    speedSource: 'provisional-derived-from-existing-feel',
    fallbackSpeedBcuPerSecondPerRawSpeed: 24,
    projectionSource: 'base-screen-x-and-provisional-bcu-base-pos',
    debug: true
  },
