...
export class BattleSceneRenderer {
  ...
  drawActor(c, actor) {
    ...
    const renderOffsetX = Number.isFinite(actor.visualRenderOffsetWorldPx) ? actor.visualRenderOffsetWorldPx : 0;
    c.translate(actor.x + renderOffsetX, actor.y);
