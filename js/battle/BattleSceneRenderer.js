...
export class BattleSceneRenderer {
  ...
  drawActor(c, actor) {
    ...
    c.translate(actor.x + modelAlignOffsetX + crowdOffsetX + kbOffsetX, actor.y + crowdOffsetY + kbOffsetY);
