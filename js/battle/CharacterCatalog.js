export const CHARACTER_CATALOG_VERSION = '0.11.0';
...
export const CHARACTER_CATALOG = Object.freeze([
  {
    ...
    sourceRoster: 'dogPlayer', sourceSlotId: 'dog-wanko', defaultCost: 50, defaultCooldownMs: 2000,
  ...
  },
  {
    ...
    sourceRoster: 'dogPlayer', sourceSlotId: 'dog-nyoro', defaultCost: 75, defaultCooldownMs: 2800,
    productionOverrides: { side: 'dog-player', direction: -1, facing: -1 },
  ...
  },
  {
    ...
    sourceRoster: 'dogPlayer', sourceSlotId: 'dog-rei', defaultCost: 100, defaultCooldownMs: 3500,
    productionOverrides: { side: 'dog-player', direction: -1, facing: -1 },
  ...
  },
  {
    ...
    sourceRoster: 'catUnits', sourceSlotId: 'cat-basic', defaultCost: 75, defaultCooldownMs: 2500,
  ...
  },
  {
    ...
    sourceRoster: 'catUnits', sourceSlotId: 'cat-tank', defaultCost: 100, defaultCooldownMs: 3500,
    productionOverrides: { side: 'dog-player', direction: -1, facing: -1, renderFlipX: false },
  ...
  },
  {
    ...
    sourceRoster: 'catUnits', sourceSlotId: 'cat-battle', defaultCost: 150, defaultCooldownMs: 3200,
    productionOverrides: { side: 'dog-player', direction: -1, facing: -1, renderFlipX: false },
