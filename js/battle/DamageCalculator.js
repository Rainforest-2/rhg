...
export class DamageCalculator {
  ...
  static buildDefaultModifiers({ attacker = null, target = null, targetType = 'actor', event = null } = {}) {
    ...
    return {
      base: 1, trait: 1, ability: 1, critical: 1, metal: 1, resistant: 1, massiveDamage: 1, insaneDamage: 1, strong: 1, tough: 1, baseDestroyer: 1, metalKiller: 1, strongAttack: 1, baronKiller: 1, stage: 1,
      notes: [], abilities, traits, targetType
    };
  }
  ...
  static calculate({ attacker = null, target = null, targetType = 'actor', event = null, context = {} } = {}) {
    ...
    for (const key of Object.keys(abilityResult.modifiers || {})) if (Object.hasOwn(modifiers, key)) modifiers[key] = abilityResult.modifiers[key] ?? 1;
    ...
    return {
      ...
      source: 'DamageCalculator.v3-bcu-integer-getDamage-result',
      abilityDebug: {
