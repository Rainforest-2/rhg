...
export function buildDogRosterEntry(spec) {
  ...
  return {
    ...
    ...(spec.combatPositionOffsetPx !== undefined ? { combatPositionOffsetPx: spec.combatPositionOffsetPx } : {}),
    ...(spec.combatEdgeInsetPx !== undefined ? { combatEdgeInsetPx: spec.combatEdgeInsetPx } : {}),
    ...(spec.combatPositionSource ? { combatPositionSource: spec.combatPositionSource } : {}),
    uiIcon: {
      kind: 'enemy',
      bcuId,
