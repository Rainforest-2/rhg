...
@media (orientation:landscape) and (max-height:520px){.bcu-pause-control{top:calc(5px + env(safe-area-inset-top,0px));left:calc(5px + env(safe-area-inset-left,0px));width:38px;height:38px}.bcu-pause-control .bcu-pause-icon{width:38px;height:38px;background-size:335.448px 335.448px;background-position:-291.552px -0.655px}.bcu-pause-overlay{padding:6px max(8px,env(safe-area-inset-right,0px)) 6px max(8px,env(safe-area-inset-left,0px))}.bcu-pause-panel{width:min(620px,calc(100vw - 16px));max-height:calc(100dvh - 12px);padding:10px;gap:8px;border-width:3px;border-radius:13px}.bcu-pause-panel-main{gap:8px 10px;grid-template-columns:minmax(0,1fr) minmax(0,1fr);grid-template-areas:"title title" "sound actions";align-items:stretch}.bcu-pause-title{grid-area:title;font-size:1.28rem}.bcu-pause-section{grid-area:sound;gap:7px;padding:8px;border-width:2px;border-radius:10px}.bcu-pause-section>h3{font-size:.9rem}.bcu-pause-actions{grid-area:actions;margin-top:0;gap:8px;align-content:center}.bcu-pause-btn{padding:8px 12px;border-width:3px;font-size:1rem}.bcu-pause-overlay .bcu-pause-sound-grid{gap:7px}.bcu-pause-overlay .bcu-pause-sound{padding:7px 8px;gap:7px;border-width:3px;border-radius:11px}.bcu-pause-overlay .bcu-pause-sound-icon{width:32px;height:32px;font-size:19px}.bcu-pause-overlay .bcu-pause-sound-icon .bi{font-size:20px}.bcu-pause-abort-label{width:184px;height:39.843px;background-size:370.784px 370.784px;background-position:-133.858px -229.627px}.bcu-pause-confirm{left:10px;right:10px;gap:8px;padding:10px;border-width:3px;border-radius:12px}.bcu-pause-confirm>p{font-size:.9rem}.bcu-pause-confirm-row{gap:7px}.bcu-pause-confirm-row button{padding:7px;border-width:2px;font-size:.84rem}}
@media (orientation:landscape) and (max-height:390px){.bcu-pause-control{top:calc(4px + env(safe-area-inset-top,0px));left:calc(4px + env(safe-area-inset-left,0px));width:34px;height:34px}.bcu-pause-control .bcu-pause-icon{width:34px;height:34px;background-size:300.138px 300.138px;background-position:-260.862px -0.586px}.bcu-pause-panel{width:min(580px,calc(100vw - 14px));padding:8px;gap:7px}.bcu-pause-title{font-size:1.12rem}.bcu-pause-section{padding:7px;gap:6px}.bcu-pause-btn{padding:7px 10px;font-size:.92rem}.bcu-pause-abort-label{width:168px;height:36.378px;background-size:338.646px 338.646px;background-position:-122.362px -209.669px}}
