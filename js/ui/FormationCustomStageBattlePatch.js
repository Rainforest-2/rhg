...
@media (orientation:landscape) and (max-height:520px) and (max-width:980px){html body.nyanko-ui-polish .formation-custom-stage-columns>section:has(.formation-custom-stage-empty){grid-template-rows:auto min-content 27px!important;align-content:start!important}html body.nyanko-ui-polish .formation-custom-stage-list-host:has(.formation-custom-stage-empty){overflow:visible!important}html body.nyanko-ui-polish .formation-custom-stage-columns [data-custom-stage-pick-side]{min-height:25px!important;padding:2px 5px!important;border-width:2px!important;border-radius:8px!important;font-size:.5rem!important;line-height:1!important;box-shadow:0 2px 0 #321407,inset 0 1px 0 rgba(255,255,255,.72)!important}html body.nyanko-ui-polish .formation-custom-stage-empty{min-height:34px!important;padding:4px!important;border-width:2px!important;border-radius:8px!important;font-size:.55rem!important}}
@media (orientation:landscape) and (max-height:390px) and (max-width:900px){html body.nyanko-ui-polish .formation-custom-stage-columns>section:has(.formation-custom-stage-empty){grid-template-rows:auto min-content 23px!important}html body.nyanko-ui-polish .formation-custom-stage-columns [data-custom-stage-pick-side]{min-height:21px!important;font-size:.45rem!important;padding:1px 3px!important}}
