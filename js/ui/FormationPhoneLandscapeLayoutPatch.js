...
@media ${PHONE_LANDSCAPE_QUERY}{
  ...
  html body.nyanko-ui-polish .formation-catalog-toolbar{grid-column:1!important;grid-row:2!important;height:30px!important;display:grid!important;grid-template-columns:minmax(0,1fr) auto!important;gap:4px!important;min-width:0!important}
  ...
  html body.nyanko-ui-polish .formation-search-button{min-width:48px!important;min-height:30px!important;height:30px!important;padding:3px 8px!important;border-width:2px!important;font-size:.62rem!important;box-shadow:0 2px 0 #3a1506,inset 0 1px 0 rgba(255,255,255,.72)!important}
