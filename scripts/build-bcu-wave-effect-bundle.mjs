...
const EFFECT_DEFS = Object.freeze([
  ...
  single({ key: 'procInvalid', role: 'bcu-INV/skill_effect_invalid', dir: 'public/assets/bcu/000001/org/battle/s0', out: 'proc-invalid', image: 'skill000.png', imgcut: 'skill000.imgcut', model: 'skill_effect_invalid.mamodel', anim: 'skill_effect_invalid.maanim' }),
  single({ key: 'unitWarpInvalid', role: 'bcu-A_FARATTACK (Entity.AnimManager.getEff(INVWARP))', dir: 'public/assets/bcu/000001/org/battle/s0/farattack', out: 'unit-warp-invalid', image: '../skill000.png', imgcut: '../skill000.imgcut', model: 'skill_farattack.mamodel', anim: 'skill_farattack.maanim' }),
  single({ key: 'enemyWarpInvalid', role: 'bcu-A_E_FARATTACK (Entity.AnimManager.getEff(INVWARP))', dir: 'public/assets/bcu/000001/org/battle/s0/farattack', out: 'enemy-warp-invalid', image: '../skill000.png', imgcut: '../skill000.imgcut', model: 'skill_farattack_e.mamodel', anim: 'skill_farattack_e.maanim' }),
  ...
  return Buffer.from(JSON.stringify({
    ...
    bcuReference: {
      ...
      importantEffects: {
        ...
        INV: './org/battle/s0/skill_effect_invalid',
