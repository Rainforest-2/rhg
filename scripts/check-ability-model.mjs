...
assert.equal(existsSync(new URL('../js/battle/ProcResolver.js', import.meta.url)), false); assert.equal(existsSync(new URL('../js/battle/KBRuntime.js', import.meta.url)), false); assert.equal(existsSync(new URL('../js/battle/EffectRuntime.js', import.meta.url)), false); ok('18');
