...
//  2. BattlePauseMenu renders the BGM/SE sliders, mute, resume and abort actions
//     and references the mirrored option atlas.
//  3. The PreviewApp pause patch installs the shared pause gate, abort routine
//     and is imported from main.js.
...
for (const piece of ['bcu-pause-bgm', 'bcu-pause-se', 'bcu-pause-mute-input', 'bcu-pause-btn resume', 'bcu-pause-btn abort', 'setBgmVolume', 'setSeVolume', 'setMuted']) {
...
// 3. PreviewApp pause patch wiring
