...
const commands = [
  ...
  ['node', ['--check', 'scripts/check-bcu-canvas-composite-pixel-parity.mjs']],
  ['node', ['--check', 'scripts/check-bcu-glow-queue-equivalence.mjs']],
  ['node', ['--check', 'scripts/check-battle-renderer-bounds-equivalence.mjs']],
  ['node', ['--check', 'scripts/check-battle-render-interpolation.mjs']],
  ['node', ['--check', 'scripts/check-install-gate.mjs']],
  ...
  ['node', ['scripts/check-bcu-canvas-composite-pixel-parity.mjs']],
  ['node', ['scripts/check-bcu-glow-queue-equivalence.mjs']],
  ['node', ['scripts/check-battle-renderer-bounds-equivalence.mjs']],
  ['node', ['scripts/check-battle-render-interpolation.mjs']],
  ['node', ['scripts/check-install-gate.mjs']],
  ['node', ['scripts/check-battle-pause-control.mjs']],
  ['node', ['scripts/check-battle-music-and-zombie-killer.mjs']],
  ['node', ['--check', 'scripts/check-bcu-lineup-slide-gesture-parity.mjs']],
  ['node', ['scripts/check-bcu-lineup-slide-gesture-parity.mjs']],
  ['node', ['--check', 'scripts/check-bcu-msd-row-alignment-parity.mjs']],
  ['node', ['scripts/check-bcu-msd-row-alignment-parity.mjs']],
  ['node', ['--check', 'scripts/check-bcu-maanim-keyframe-integrity.mjs']],
  ['node', ['scripts/check-bcu-maanim-keyframe-integrity.mjs']],
  ['node', ['--check', 'scripts/check-bcu-renderer-patch.mjs']],
  ['node', ['scripts/check-bcu-renderer-patch.mjs']],
  ['node', ['--check', 'scripts/check-bcu-castle-runtime-geometry.mjs']],
