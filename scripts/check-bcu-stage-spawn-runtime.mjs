...
function mkRuntime(row){return {enemyRows:[row],enemyBaseFrontX:800,maxEnemyCount:5};}
...
for (const k of ['rowIndex','magnification','hpMagnification','attackMagnification','layerMin','layerMax','rawEnemyId','sourceEnemyId','enemyId']) assert.ok(k in ev);
